...
// Add elements
std1.push("green");
std1.unshift("Mr."); // mulata add krna onanm @@@@@@@@@@@@@@@@@@@@
console.log(std1);

// Remove elements
std1.pop(); // last walin ain wei
std1.pop();
std1.shift(); // mulin ain wei
console.log(std1);

// Get index of an element => 22 tyene kiweni index ekeda kiyla(element natnm -1 dei)
console.log(std1.indexOf(22));

var isAgriStudent =
  std1.indexOf("Civil") === -1
    ? std1[0] + " is not a Agri student"
    : std1[0] + " is a Civil student";

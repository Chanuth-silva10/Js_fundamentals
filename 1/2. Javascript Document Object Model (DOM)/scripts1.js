...
formTitle.textContent = "Add Shopping Items";//text content eka change kri. mekta dala tyena style gana consider wen na
...
*/
console.log(formTitle.textContent); // style salkn na
console.log(formTitle.innerText); // style apply karagani
console.log(formTitle.innerHTML); // html dana puluwn
...
// --ID--
var hd = document.querySelector("#navbar");// serma select wunata mul eka dei
